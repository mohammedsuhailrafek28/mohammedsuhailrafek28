...
```python
class SuhailRafek:
    name        = "Mohammed Suhail Rafek"
    alias       = "aswath_tamilan"
    ...
    stack = [
        "Python", "TypeScript", "React.js", "Next.js",
        "FastAPI", "Node.js", "PostgreSQL", "MongoDB",
        "Machine Learning", "Docker", "Flutter"
    ]
    ...
    fun_fact = "I build full-stack AI products and win hackathons with them 🏆"

    def motto(self):
        return "Ship it. Learn from it. Build something bigger. 🚀"
```
...
<details>
<summary><b>🚀 Founder and Lead Developer — RoadLens AI</b> | <em>2025 – Present | Chennai, India</em></summary>
...
- Deployed a full-stack web application live at [roadlens-ai.vercel.app](https://roadlens-ai.vercel.app/).
- Researching novel ML features: acoustic risk fingerprinting, ghost accident detection, and chaos window forecasting.

</details>

<details>
<summary><b>🩺 AI Platform Engineer — MedX</b> | <em>2025 – Present | Chennai, India</em></summary>
...
<details>
<summary><b>🎓 ML and Full-Stack Engineer — CIT Sentinel (Aura-Dash)</b> | <em>2025 – 2026 | Chennai, India</em></summary>
...
<details>
<summary><b>👗 Frontend and AI Engineer — CAELIX FIT</b> | <em>2025 – Present | Chennai, India</em></summary>

<br/>

- Developed an **AI-powered fashion and lifestyle platform** with personalised recommendations and premium UI using **React.js**, **TypeScript**, **Firebase**, and **Tailwind CSS**.
...
|:---|:---|:---|:---:|
| **CIT Sentinel (Aura-Dash)** 🥉 | React · TypeScript · Node.js · Recharts | Predictive student retention engine — won Rs.10,000 at CIT SDG Hackathon 2026 | [Demo](https://cit-sentinal.vercel.app/) |
| **RoadLens AI** | Next.js · FastAPI · ML | Intelligent road safety platform with AI-driven hazard detection and risk maps | [Demo](https://roadlens-ai.vercel.app/) |
| **MedX** | Python · FastAPI · React · PostgreSQL | Privacy-preserving federated learning platform for healthcare AI research | [Demo](https://medx-beta.vercel.app) |
...
| ✈️ British Airways Data Science Simulation | Jan 2026 | British Airways / Forage |
